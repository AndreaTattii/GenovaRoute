<?php
    ...
    $sql="SELECT * FROM utente_percorre_tappa, tappa WHERE email = '" . $email . "' AND tappa.id=id_tappa ORDER BY (utente_percorre_tappa.data)DESC";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo   "
                    <div class='col-4' style='height: 90px; padding:0px; margin:0px;'>
                        <a  href='mostraTappeV.php?idTappa=".$row['id']."&email=".$email."'>   
