...
<body onload="toTappa()">
    ...
    <div class="container fixed-top">
        <div class="row justify-content-center align-items-center" style="background-color: #B30000;  padding-top: 10px; height:60px;">
            ...
            <div class="col-8">
                <h1 style=" color: white; font-weight: bold; text-align: center;  font-size: 20px;">Mi piace</h1>
            </div>
            <div class="col-2">
        ...
        if ($result = $connessione->query($sql)) {
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()){
                    echo '
                        <div class="card text-center" id="'.$row['id'].'"  style="margin-top:20px; border-radius:0px; text-align: left; padding-top:60px; margin:0px; border:none;">

                            <div class="card-header" style="background-color:white; margin-left:0px; padding-left:0px">
                                <p class="card-title" style="font-weight: bold; margin-left: 10px;"><img src="../../img/icons/marker.png" style="width: 30px;  ">'.$row['via'].'</p>
                        ...
                        <div id="gestureZone" class="card-body" style="text-align: center; border:none; ">
                            ...
                            <p class="card-text" style="text-align:justify; border:none;">'.$row['descrizione'].'</p>
                        </div>
                    ';
                }
